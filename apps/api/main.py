...
app = FastAPI(title="AEGIS API", version="0.2.1", description="Autonomous Enterprise Graph Intelligence System")
...
async def root():
    ...
    return {"status": "online", "message": "AEGIS API is running", "docs": "/docs", "ui": "/ui", "version": "0.2.1", "graph_loaded": graph is not None, "graph_error": graph_load_error}
